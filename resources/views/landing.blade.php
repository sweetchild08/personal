...
<head>
    <title>Portfolio: Warren Dalawampu</title>
    <meta charset="utf-8">
...
<body data-spy="scroll" data-target="#pb-navbar" data-offset="200">
    ...
    <section class="site-hero" style="background-image: url(images/pic.jpg);background-size: cover;" id="section-home" data-stellar-background-ratio="0.5">
        <div class="container">
            <div class="row intro-text align-items-center justify-content-center">
                <div class="col-md-10 text-center pt-5">

                    <h1 class="site-heading site-animate">Hello, I'm <strong class="d-block">Warren Dalawampu</strong></h1>
        ...
        <div class="container">
            ...
            <!-- <div class="filters">
				<ul>
					...
					<li data-filter=".packaging">Technology used</li>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="resume-item mb-4">
                        <span class="date"><span class="icon-calendar"></span> 2019 - 2021</span>
                        <h3>Master of Science in Information Technology <b>(30 Units)</b></h3>
                        <br>
                        <!-- <p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic.</p> -->
                        <span class="school">Batangas State University</span>
                        <p>Alangilan, Batangas City</p>
                    </div>

                    <div class="resume-item mb-4">
                        <span class="date"><span class="icon-calendar"></span> 2015 - 2019 </span>
                        <h3>Bachelor of Science in Information Technology</h3>
                        <br>
                        <!-- <p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic.</p> -->
                        <span class="school">Mindoro State University</span>
                ...
                <div class="col-md-6">
                    ...
                    <div class="resume-item mb-4">
                        <span class="date"><span class="icon-calendar"></span> April 17, 2023 - Present</span>
                        <h3>PHP Backend Developer</h3>
                        <p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic.</p>
                        <span class="school">1 Bit Software Development Corp</span>
                        <p>41st Floor, G.T. International Tower, 6813 Ayala Avenue, H.V. Dela Costa, Makati</p>
                    </div>

                    <div class="resume-item mb-4">
                        <span class="date"><span class="icon-calendar"></span> October 02, 2020 - April 17, 2023</span>
                        <h3>Junior Backend Developer</h3>
                        <p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic.</p>
                        <span class="school">MVSoftech Inc</span>
                        <p>Governor Infantado St. Calapan City, Oriental Mindoro</p>
                    </div>

                    <div class="resume-item mb-4">
                        <span class="date"><span class="icon-calendar"></span> July 2019 - September 2020</span>
                    ...
                    <div class="resume-item mb-4">
                        ...
                        <h3>Management Information System (OJT)</h3>
                        <p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic.</p>
                        <span class="school">Mindoro State University</span>
                        <p>Masipit, Calapan City, Oriental Mindoro</p>
                    </div>
        ...
        <div class="container">
            <div class="row mb-5 align-items-center">
                <div class="col-lg-7 pr-lg-5 mb-5 mb-lg-0">
                    <img src="images/id.jpg" alt="Image placeholder" class="img-fluid">
                </div>
                <div class="col-lg-5 pl-lg-5">
                    <div class="section-heading">
                        <h2>About <strong>Me</strong></h2>
                    </div>
                    <p class="lead">Im Warren, 26 years old, a Full Stack Engineer</p>
                    <p class="mb-5  ">Experienced software engineer with a focus on efficient and scalable
                        application development. Skilled in JavaScript, PHP, HTML, CSS and
                        SQL. Proven success in managing full project lifecycle and collaborating
                        with cross-functional teams. Seeking a challenging role to drive
                        innovation and improve business processes.</p>

                    <p>
                        <a href="#section-contact" class="btn btn-primary px-4 py-2 btn-sm smoothscroll">Hire Me</a>
                        <a href="/downloads/resume.pdf" class="btn btn-secondary px-4 py-2 btn-sm">Download CV</a>
                    </p>
                </div>
            </div>
                ...
                <div class="col-md-5 pl-md-5">
                    ...
                    <ul class="site-contact-details">
                        <li>
                            ...
                            sweetchild00008@gmail.com <br>
                            dalawampuwarren@gmail.com
                        </li>
                        <li>
    ...
    <footer class="site-footer">
        <div class="container">
            ...
            <div class="row mb-5">
                <div class="col-md-12 text-center">
                    <p>
                        <a href="https://www.facebook.com/sweetchild008" class="social-item"><span class="icon-facebook2"></span></a>
                        <a href="https://twitter.com/WDalawampu" class="social-item"><span class="icon-twitter"></span></a>
                        <a href="https://www.instagram.com/warrendalawampu/" class="social-item"><span class="icon-instagram2"></span></a>
                        <a href="https://www.linkedin.com/in/fafawar/" class="social-item"><span class="icon-linkedin2"></span></a>
                        <a href="https://github.com/sweetchild08" class="social-item"><span class="icon-github2"></span></a>
